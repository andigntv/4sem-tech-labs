...
/**
 * class for withdrawing transaction
 */
public class WithdrawingTransaction implements TransactionInterface {
    ...
    public WithdrawingTransaction(AccountInterface account, ZonedDateTime dateTime, int id, double amount) throws TransactionException {
        if (account == null)
